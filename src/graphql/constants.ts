...
export const graphUrls: Record<SupportedChainId, dexGraph> = {
  ...
  [SupportedChainId.polygon]: {
    [SupportedDex.UniswapNew]: {
      ...
      publishedUrl:
        'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/9x1nQRYUBpBjr8V4TKAKBKDxoeVuijYYA8PNhkTFECkY',
      supportsCollectFees: true,
      version: 2,
    },
    [SupportedDex.UniswapV3]: {
  ...
  [SupportedChainId.base]: {
    ...
    [SupportedDex.AerodromeV2]: {
      url: 'https://api.studio.thegraph.com/query/88584/base-v-4-aerodrome/version/latest',
      publishedUrl:
        'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/6FbCkQmWjtemPMkuxCtAE4btLBLLyxhh5zWnjUFi5Acf',
      supportsCollectFees: true,
      version: 2,
    },
    [SupportedDex.Aux]: {
    ...
    [SupportedDex.Hydrex]: {
      ...
      publishedUrl:
        'https://gateway-arbitrum.network.thegraph.com/api/[api-key]/subgraphs/id/AusreZtgQFkkCDsvGZ6uLZxxCD3KwcpCjrE2sK3ZkW1J',
      supportsCollectFees: true,
      version: 2,
    },
    [SupportedDex.Kim]: {
